<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM tb_pelanggan_off WHERE id='".$_GET['kode']."'";
			...
			<div class="box box-success">
				...
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">Mac Modem</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="date" class="form-control" id="tanggal_pemasangan" name="tanggal_pemasangan" value="<?php echo explode(' ', $data_cek['tanggal_pemasangan'])[0]; ?>">
							</div>
						</div>
...
if (isset ($_POST['Ubah'])){
	$sql_ubah = "UPDATE tb_pelanggan_off SET
		nama='".$_POST['nama']."',
	...
	if ($query_ubah) {
		...
		Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
			...
			if (result.value) {
				window.location = 'index.php?page=pelanggan-off';
			}
		})</script>";
		}else{
		echo "<script>
