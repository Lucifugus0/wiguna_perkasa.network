...
<?php
	...
	// $pengguna = $koneksi->query("SELECT * from tb_pengguna where username='kontuku'");
			...
			<div class="table-responsive">
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<?php
                  $no = 1;
                  $sql = $koneksi->query("SELECT p.id_pelanggan, p.nama, p.mac_modem, p.alamat, p.patokan, p.no_hp, t.id_tagihan, t.tagihan, t.kode_unik, t.status, t.tgl_bayar 
                ...
                ?>
						...
						<tr>
							...
							<td>
								...
								<a href="?page=bayar-tagihan&kode=<?php echo $data['id_tagihan']; ?>" title="Bayar Tagihan" class="btn btn-info">
