...
<head>
	...
	<title>DATA TAGIHAN INTERNET Wiguna Perkasa Network</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<marquee>
						<b>DATA TAGIHAN INTERNET Wiguna Perkasa Network</b>
					</marquee>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										WIGUNA PERKASA GRUP (PAKET BULANAN)
									</b>
								</span>
							</a>
						</li>
        ...
        ?>
					...
					<li class="treeview">
						<a href="?page=pelanggan-off">
							<i class="fa fa-user"></i>
							<span>Pelanggan Off</span>
							<span class="pull-right-container">
							</span>
						</a>
					</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
			...
			//Log Aktifitas
			case 'log-aktifitas':
				include "admin/log_aktifitas.php";
				break;
				
			//Pelanggan Off
			case 'pelanggan-off':
				include "admin/pelanggan_off.php";
				break;
			case 'edit-pelanggan-off':
				include "admin/pelanggan_off/edit_pelanggan.php";
				break;
			case 'del-pelanggan-off':
		...
		<footer class="main-footer">
			...
			<center>
				<strong>Copyright &copy;
					<a href="https://youtu.be/zocJH2MQH4w">Chandra Software House</a>.</strong> All rights reserved.
			</center>
		</footer>
