...
Halo *$tagihan_nama* 👋
*Kami informasikan* bahwa tagihan WiFi Wiguna Perkasa Network untuk periode Bulan $bulan,  Tahun $tahun sudah terbit Dan bisa mulai di bayarkan.

💳 Nominal	: Rp *$tagihan_rupiah.*
🗓️ Batas pembayaran	: *Dari mulai tanggal 1 sampai batas akhir tanggal 5.*

Pembayaran dapat dilakukan melalui transfer sesuai metode yang biasa digunakan. *tinggal scan aja QRIS di atas!✨*
Setelah melakukan pembayaran, mohon kirimkan bukti transfer agar layanan tetap aktif tanpa kendala.

Terima kasih atas kepercayaannya menggunakan layanan WiFi kami 🙏
Semoga jaringan selalu lancar dan membantu aktivitas Kakak setiap hari.

Informasi tata cara pembayaran:
*Scan kode QR diatas.*
Silahkan Ketik link dibawah ini :
https://wigunaperkasa.my.id/carapembayaran/bayarwifi.txt

*PENTING* :
*1.Pembayaran diluar KODE QR yang terdaftar diatas bukan tanggung jawab kami.*
*2.Untuk pembayaran dan semua transaksi harus melalui KODE QR diatas dan sesuai nominal yang terdaftar, Agar bisa terinput secara otomatis di sistem.*
