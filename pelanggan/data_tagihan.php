		...
		<div class="box-body">
			<div class="table-responsive">
				<table id="example1" class="table table-bordered table-striped">
				  ...
				  if (@$_GET['status'] && in_array($_GET['status'], ['BL', 'LS']))
					$sql = $koneksi->query("SELECT * from tb_tagihan where id_pelanggan='$data_id' AND status = '{$_GET['status']}' order by tgl_bayar asc");
